...
\paragraph{Precision measurements: Stedman \& Nilsson (1966).} Stedman and Nilsson performed the most precise phonon measurements on aluminum, using a triple-axis spectrometer at 80 K and 300 K (204 citations). They achieved random errors of only $\sim$0.6\% and total errors of 1--2\%. Their key findings:
\begin{itemize}[nosep]
  \item \textbf{Kohn anomalies} in the dispersion curves, caused by the abrupt change in the electronic screening at $2k_F$.
  \item \textbf{Phonon widths} at 80 K interpreted as arising from the electron--phonon interaction.
  \item Interplanar force constants extending to at least 15th neighbors (2.6 lattice spacings).
\end{itemize}

\paragraph{Temperature dependence: Kresch et al.\ (2008).} Kresch and coworkers measured the phonon density of states of aluminum at 10, 150, 300, 525, and 775 K using Fermi chopper spectrometers (66 citations). They found:
\begin{itemize}[nosep]
  \item Significant softening of longitudinal force constants with increasing temperature.
  \item Phonon broadening at high temperatures due to phonon--phonon interactions.
  \item The quasiharmonic approximation works well, but breaks down above $\sim$500 K.
\end{itemize}
